  ...
  <div class="content"<?php print $content_attributes; ?>>
    ...
    <div class="row">
	    <div class="col-md-3 col-sm-6 get-involved">
			...
			<?php echo l('<i class="fa fa-heart"></i> '.t('Donate'), 'node/36', array('attributes' => array('class' => array('btn', 'btn-default')), 'html' => true)); ?>
			<?php echo l(t('Volunteer'), 'volunteer', array('attributes' => array('class' => array('btn', 'btn-default')))); ?>
	    </div>
	    <div class="col-md-3 col-sm-6 recent-blogs">
		    <h4><span class="hi">Recent</span> blogs</h4>
		    <?php echo views_embed_view('latest_blog_posts', 'block_1'); ?>
	    </div>
	    <div class="col-md-3 col-sm-6 news-signup">
		    <h4><span class="hi">News</span> signup</h4>
