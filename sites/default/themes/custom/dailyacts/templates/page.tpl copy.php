...
?>
<div id="front-carousel" class="carousel slide hidden-xs hidden-sm" data-ride="carousel" data-interval="0">
  <!-- Indicators -->
  ...
  <div class="carousel-inner" role="listbox">
  		<?php 
		foreach($slide_set as $key => $value){ 
				$slide['image'] = file_create_url($value->field_carousel_image['und'][0]['uri']);
				$slide['caption1'] = $value->field_caption_1['und'][0]['safe_value'];
				$slide['caption2'] = $value->field_caption_2['und'][0]['safe_value'];
				$slide['button_set'] = $value->field_button_set['und'][0]['safe_value'];
		...
		?>
			...
			<div class="slide-art" class="slide-art" style=" height: 500px; background-image: url(<?php echo $slide['image']; ?>); opacity: 0.5;"></div>
...
<div class="interior-header-image" data-parallax="scroll" data-image-src="<?php echo $theme_path; ?>images/headers/staff.jpg">
	        <h1 class="page-header"><span><?php print $title; ?></span></h1>
</div>
